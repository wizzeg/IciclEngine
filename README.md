...
This engine is primarily using data oriented design, with some use of object oriented programming where it makes more sense (or will not impact game performance). Everything that can be multi-threaded is multi-threaded.
